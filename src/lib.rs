...
fn validate_envvar_with_rule(rule: &Rule, env_vars: &[apicore::EnvVar]) -> Result<()> {
    ...
    let error_message = match rule.reject {
        settings::Operator::AllAreUsed => {
            ...
            let mut invalid_envvar = validation_envvar
        ...
        settings::Operator::AnyIn => {
            ...
            let mut invalid_envvar: Vec<String> = envvar_intersection
...
mod tests {
    ...
    #[case::anyin_fail_all_envvar_is_defined(
        ...
        Some(format!("{} envvar2, envvar3", ANY_IN_ERROR_MSG.to_owned())))]
    #[case::anyin_fails_when_an_envvar_with_value_is_defined(
        ...
        Some(format!("{} envvar2", ANY_IN_ERROR_MSG.to_owned())))]
    #[case::anyin_fail_when_envvar_with_name_only_is_defined(
        ...
        Some(format!("{} envvar3", ANY_IN_ERROR_MSG.to_owned())))]
    ...
    #[case::anynotin_fail_envvar_with_value(
        ...
        Some(format!("{} envvar3", ANY_NOT_IN_ERROR_MSG.to_owned())))]
    #[case::anynotin_fail_envvar_name_only(
        ...
        Some(format!("{} envvar2", ANY_NOT_IN_ERROR_MSG.to_owned())))]
    #[case::anynotin_fail_no_envvar(
        ...
        vec![],
        Some(format!("{} envvar2, envvar3", ANY_NOT_IN_ERROR_MSG.to_owned())))]
    #[case::allareused_fail_all_envvar_are_defined_in_rule(
        ...
        Some(format!("{} envvar2, envvar3", ALL_ARE_USED_ERROR_MSG.to_owned())))]
    ...
    #[case::notallareused_no_envvar_should_succeed(
        ...
        vec![ ], Some(format!("{} envvar2, envvar3", NOT_ALL_ARE_USED_ERROR_MSG.to_owned())))]
    #[case::notallareused_mismatch_envvar(
       ...
       Some(format!("{} xpto", NOT_ALL_ARE_USED_ERROR_MSG.to_owned())))]
    ...
    #[case::anynotin_mismatch_envvar(
       ...
       Some(format!("{} xpto", ANY_NOT_IN_ERROR_MSG.to_owned())))]
    fn rules_test(
        #[case] rule: Rule,
